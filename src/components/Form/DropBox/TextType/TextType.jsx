      ...
      <FormControl required>
        ...
        <Input
          ...
          slotProps={{
            input: {
              className: clsx(
                "w-full h-fit text-sm font-normal font-sans leading-normal text-slate-900 bg-white border border-solid border-slate-200 px-3 py-2 rounded-lg hover:bg-slate-100 hover:border-slate-400 focus:outline-0 "
              ),
            },
          }}
        />
